...
# ARTIFACTS contains path to folder with .cov files
ARTIFACTS ?= $(shell pwd)
...
test: manifests generate fmt vet envtest ## Run tests.
	KUBEBUILDER_ASSETS="$(shell $(ENVTEST) use $(ENVTEST_K8S_VERSION) --bin-dir $(LOCALBIN) -p path)" go test ./... -coverprofile $(ARTIFACTS)/cover.out
