...
printf "${BLUE_COLOR}[ 1 ]${NORMAL_COLOR} Create k3d cluster and registry\n"
kyma-dev provision k3d --registry-port ${K3D_REGISTRY_PORT} --name ${K3D_CLUSTER_NAME} --ci
kubectl create namespace kyma-system

printf "\n${BLUE_COLOR}[ 2 ]${NORMAL_COLOR} Create module template\n"
...
printf "\n${BLUE_COLOR}[ 3 ]${NORMAL_COLOR} Fix moduletemplate\n"
...
## deploy LM
printf "\n${BLUE_COLOR}[ 4 ]${NORMAL_COLOR} Deploy LM\n"
kyma-dev alpha deploy --ci --force-conflicts

## apply moduletemplate
printf "\n${BLUE_COLOR}[ 5 ]${NORMAL_COLOR} Apply moduletemplate\n"
kubectl apply -f moduletemplate-k3d.yaml

## enable warden module
printf "\n${BLUE_COLOR}[ 6 ]${NORMAL_COLOR} Enable warden module\n"
kyma-dev alpha enable module warden -c fast

## verify
printf "\n${BLUE_COLOR}[ 7 ]${NORMAL_COLOR} Verify\n"
